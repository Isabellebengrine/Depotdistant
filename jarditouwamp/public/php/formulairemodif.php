      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="row m-1 m-sm-1">
          <div class="col-12 col-sm-12 text-justify">
            <form method="post" action="<?php echo 'http://localhost/jarditou/public/php/produitsmodif.php?pro_id='.$produit->pro_id.'"';?>" id="formulaire_modif">
              ...
              <div class="form-check-inline">
                <label class="form-check-label">Produit bloqué:
                  <input type="radio" class="form-check-input" name="optradio" value="1" <?php if (!is_null($produit->pro_bloque)) { echo "checked"; } ?>>Oui
                </label>
            </div>
            <div class="form-check-inline">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="optradio" value="" <?php if (is_null($produit->pro_bloque)) { echo "checked"; } ?>>Non
              </label>
            </div>
        ...
        <script src="public/js/controlmodif.js"></script>
   </body>
 </html>