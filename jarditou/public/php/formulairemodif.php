      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="row m-1 m-sm-1">
          <div class="col-12 col-sm-12 text-justify">
            <form method="post" action="http://localhost/jarditou/produitsmodif.php" id="formulaire_modif">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="catpdt" name="catpdt" value="<?php echo $produit->cat_nom;?>">
              ...
              <div class="form-check-inline">
                <label class="form-check-label">Produit bloqué:
                  <input type="radio" class="form-check-input" name="optradio" <?php if (!is_null($produit->pro_bloque)) { echo "checked"; } ?>>Oui
                </label>
            </div>
            <div class="form-check-inline">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="optradio" <?php if (is_null($produit->pro_bloque)) { echo "checked"; } ?>>Non
              </label>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="modifpdt" name="modifpdt" value="<?php echo $produit->pro_d_modif;?>">
              </div>
