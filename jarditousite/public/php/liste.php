...
foreach ($tableau as $row)
{
    ...
    echo '<td  class="table-warning"><img src="../images/'.$image.'" width="200" alt="Image du produit"></td>';
    //chemin absolu /jarditou/public/... bug lors mise en ligne donc changé à /public/... test
