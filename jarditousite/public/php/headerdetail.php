    ...
    <div class="container">
        <header>
            <div class="row justify-content-between">
                <div class="col-md-2">
                    <img src="../images/jarditou_logo.jpg" alt="logo Jarditou" title="logo jarditou" class="img-fluid">
                </div>
                <div class="col-md-4">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark m-2 m-sm-1">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto navbar-dark">
                    ...
                    <button class="btn btn-dark my-2 my-sm-0" type="button" value="Deconnexion" id="btnDeconnexion">Déconnexion</button>
            </div> 
        </nav>
        <div class="row">
            <div class="col-12 col-sm-12">
                <img src="../images/promotion.jpg" title="Promotion" alt="photo de promotion" class="img-fluid">
            </div>
        </div>